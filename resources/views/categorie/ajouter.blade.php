      ...
      <hr>
                ...
                <section id="section1">
                    <div class="container-fluid col-md-6 col-md-offset-3">                  
                        <form id="regForm" method="post" action="{{route('categories.store')}}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <h1>Formulaire categories</h1>
                            <!-- One "tab" for each step in the form: -->
                            <div class="tab">
                                <div class="titre"><b style="color:red;">*</b>Catégorie:</div>
                                <p><input placeholder="Categorie" oninput="this.className = ''" name="nom_cate" required></p>
