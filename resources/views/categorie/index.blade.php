...
<body>
  ...
  <div id="breadcrumb" style="background-color:lightgreen;">
    <div class="container" style="background-color:lightgreen;">
      <div class="breadcrumb" style="background-color:lightgreen;">
        ...
        <li>Catégories</li>
        <li><a href="/categories/create">Ajouter Categorie</a></li>
      </div>
    </div>
  </div>
  ...
  <div class="aboutus">
    <div class="container">
    <center><h3>Les categories</h3></center>
      <hr>
...
<tr>
        ...
        <td style="font-size:12px; color:black; width:100px;">{{ $categorie->id }}</td>
        <td style="font-size:12px; color:black; width:100px;">{{ $categorie->nom_cate }}</td>
        
   <!--  <td style="width:100px;">


        <a class="btn btn-primary" href="{{ route('categories.show',$categorie->id) }}" style="background-color:lightgreen;">Je m'inscris</a>
          ...
          <div class="copyright" style="color:black;">
            ...
            <div class="credits">
              <!--
                ...
                Licensing incategorie: https://bootstrapmade.com/license/
