			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide ">
						...
						</svg><span class="side-menu__label">Projet</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
							<li class="sub-slide">
<!-- 								<a class="sub-side-menu__item" data-toggle="sub-slide" href="/inscription"><span class="sub-side-menu__label">Ajouter un Utilisateur</span><i class="sub-angle fe fe-chevron-down"></i></a>
 -->								<!-- <ul class="sub-slide-menu"> -->
									<li><a class="sub-slide-item" href="/">Ajouter Un projet</a></li>
									<!-- <li><a class="sub-slide-item" href="{{ url('#' . $page='#') }}">Level02</a></li> -->
								<!-- </ul> -->
							</li>
						</ul>
					...
					<li class="slide ">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
						<span class="side-menu__label">Utilisateur</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
							<li class="sub-slide">
<!-- 								<a class="sub-side-menu__item" data-toggle="sub-slide" href="/inscription"><span class="sub-side-menu__label">Ajouter un Utilisateur</span><i class="sub-angle fe fe-chevron-down"></i></a>
 -->								<!-- <ul class="sub-slide-menu"> -->
									<li><a class="sub-slide-item" href="/signup">Ajouter un Utilisateur</a></li>
									<!-- <li><a class="sub-slide-item" href="{{ url('/' . $page='#') }}">Level02</a></li> -->
								<!-- </ul> -->
							</li>
						</ul>
